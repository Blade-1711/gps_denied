...
class PrecisionLanding(Node):
    ...
    def __init__(self):
        ...
        # Second color (print color for dual-color detection)
        self.declare_parameter('color2_h_low', 0)
        self.declare_parameter('color2_h_high', 180)
        self.declare_parameter('color2_s_low', 0)
        self.declare_parameter('color2_s_high', 255)
        self.declare_parameter('color2_v_low', 0)
        self.declare_parameter('color2_v_high', 75)
        ...
        self.hsv_low2 = np.array([
            self.get_parameter('color2_h_low').value,
            self.get_parameter('color2_s_low').value,
            self.get_parameter('color2_v_low').value])
        self.hsv_high2 = np.array([
            self.get_parameter('color2_h_high').value,
            self.get_parameter('color2_s_high').value,
            self.get_parameter('color2_v_high').value])
